...
class CalendarResource extends JsonResource
{
    ...
    /**
     * @return array{id: int, display_name: string, description: string|null, color: string|null, timezone: string|null, components: array<int, string>, access: int, is_owner: bool, is_shared: bool, can_write: bool, transparent: bool, share_display_name: string|null, share_invite_status: int|null}
     */
